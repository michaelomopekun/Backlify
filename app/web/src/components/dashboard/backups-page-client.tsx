...
function TriggerPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    <>
      ...
      />
      {/* Panel */}
      <div className="fixed right-0 top-0 h-full w-[420px] bg-[#0d0d0d] border-l border-[#1e1e1e] z-50 flex flex-col shadow-2xl">
        {/* Header */}
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-[28px] font-normal tracking-tight text-white">Backups</h1>
      ...
      <div className="rounded-lg border border-[#1a1a1a] bg-[#0f0f0f] p-6">
        ...
        {/* Summary strip */}
        <div className="mt-5 pt-4 border-t border-[#1a1a1a] flex items-center gap-6 text-[11.5px] font-mono text-[#555555]">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search…"
                className="h-8 pl-8 pr-3 bg-[#111111] border border-[#1e1e1e] rounded text-[12px] text-white placeholder-[#444444] focus:outline-none focus:border-[#333333] transition-colors w-44"
              />
            </div>
